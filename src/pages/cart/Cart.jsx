...
const Cart = ({cart,handleDec,handleInc,handleRemove , getTotalPrice ,applyPromoCode,promoCode,setPromoCode , invalid}) => {
  ...
  <div class="w-[90%] mx-auto mt-10">
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        <a href="" className="flex font-semibold text-indigo-600 text-sm mt-10 cursor-pointer "  onClick={()=>navigate("/allproducts")}>
      ...
      <div id="summary" className="w-full lg:w-1/4 px-8 py-10 bg-[#f6f6f6] ">
        ...
        <div className="py-10">
          ...
          {
          promoCode && promoCode !== "DISCOUNT10" ? (<span>{invalid}</span>):(<span>use DISCOUNT10</span>)

          }
          {
            promoCode === "DISCOUNT10" && (
            <span  className=' text-green-500'>Promocode Apply Successfully </span>
            )
          }
        </div>
